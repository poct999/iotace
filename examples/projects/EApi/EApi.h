 ...
 */
/**
 * \param pBuffer [out, array[pBufLen]]
...
/**
 * \param pStorageSize [out]
 * \param pBlockLength [out]
 */
EApiStatus_t 
EAPI_CALLTYPE 
EApiStorageCap(
 ...
 */
/**
 * \param pBuffer [out, array[BufLen]]
 */
EApiStatus_t 
EAPI_CALLTYPE 
EApiStorageAreaRead(
 ...
 */
/**
 * \param pWBuffer [in/out, array[WriteBCnt+1]]
 * \param pRBuffer [out, array[RBufLen+1]]
 */
...
/**
 * \param pBuffer [in, array[ByteCnt]]
 */
EApiStatus_t 
EAPI_CALLTYPE
EApiI2CWriteTransfer(
...
/**
 * \param pMaxDelay [out]
 * \param pMaxEventTimeout [out]
 * \param pMaxResetTimeout [out]
 */
EApiStatus_t 
EAPI_CALLTYPE
EApiWDogGetCap(
